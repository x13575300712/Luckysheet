...
const dataVerificationCtrl = {
    ...
    dropdownListShow: function(searchText){
        $("#luckysheet-dataVerification-showHintBox").hide();
        ...
        let scrollTop = $("#luckysheet-cell-main")[0].scrollTop;

        let downHeight = clientHeight - row - 30 + scrollTop;
        // if(downHeight > myh){
        //     downHeight = myh
        // }
        ...
        //     })
        // }
        if(row - scrollTop > ( clientHeight - 42 - 6 ) / 2){
            row = Store.visibledatarow[rowIndex - 1] - 2
            let height = row - scrollTop;
            // if(height > myh) {
            //     height = myh
            // }
            $("#luckysheet-dataVerification-dropdown-List").css({
